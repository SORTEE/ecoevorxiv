...
## What is a preprint? {#what-preprint}
A preprint is generally considered “a manuscript draft that has not yet been subject to formal peer review, distributed to receive early feedback on research from peers” (Source: [Open Research Glossary](https://figshare.com/articles/Open_Research_Glossary/1482094)). 

## What is a postprint? {#what-postprint}
A postprint is a manuscript that is submitted to and accepted for publication by a scholarly journal. Most often this is a version that does not include the journal’s formatting or author copies of published papers if you have the right to distribute it. Please check publisher copyright policies and self-archiving using Jisc's Open Policy Finder (<https://openpolicyfinder.jisc.ac.uk/>; formerly Sherpa Romeo).

## What is a preprint server? {#preprint-server}
...
## What types of preprints can be uploaded to EcoEvoRxiv preprint server? {#preprint-types}
EcoEvoRxiv hosts manuscripts in ecology, evolutionary biology, and related fields describing empirical, theoretical, and synthesis studies, as well as review papers, opinion pieces, reports and data papers.

## What are publishers' policies on preprints? {#publisher-policies}
Most journals accept manuscripts previously archived as preprints. You can check publisher copyright policies and self-archiving using Jisc's Open Policy Finder (<https://openpolicyfinder.jisc.ac.uk/>; formerly Sherpa Romeo).

## Why use a preprint server? {#why-preprints}
...
## When should I upload my preprint? {#when}
...
## We already have preprint providers such as [bioRxiv](https://www.biorxiv.org/), why another one? {#why-ecoevorxiv}
...
## Can I post a preprint on EcoEvoRxiv and other preprint servers at the same time? {#multiple-platforms}
