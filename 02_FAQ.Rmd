...
```{r echo=FALSE, include=TRUE, message=FALSE, warning=FALSE, results=FALSE}
# Load packages
pacman::p_load(vembedr, tidyverse)
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=CUSbYNNrXuU") %>% use_align("center")
```
